...
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct CreatorProfileInsert<'d> {
    user_id: Uuid,
...
#[derive(Clone, Queryable, Selectable, serde::Serialize)]
#[diesel(table_name = schema::creatorprofile)]
#[diesel(check_for_backend(diesel::pg::Pg))]
pub struct CreatorProfileQuery {
